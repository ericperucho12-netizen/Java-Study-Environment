...
/**
 * ---------------------------------------------------------
 * EJERCICIO 200: PRÁCTICA DE REGEX
 * ---------------------------------------------------------
 * Conceptos: Pattern, Matcher, Sintaxis Regex.
 * 
 * Enunciado:
 * Evalúa si el texto de prueba contiene solo números usando 
 * la expresión regular "\\d+". (Práctica #200).
 */
public class Ejercicio_200 {
    public static void main(String[] args) {
        System.out.println("=== VALIDACIÓN REGEX #200 ===");
        String texto = "12345" + (200 - 190);
