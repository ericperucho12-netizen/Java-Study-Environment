...
/**
 * ---------------------------------------------------------
 * EJERCICIO 190: PRÁCTICA CON HTTP CLIENT
 * ---------------------------------------------------------
 * Conceptos: HttpClient, HttpRequest, HttpResponse, JSON.
 * 
 * Enunciado:
 * Realiza una petición GET al servidor de pruebas de JSONPlaceholder
 * y muestra la respuesta en consola. (Simulación de consumo de API #190).
 */
public class Ejercicio_190 {
    public static void main(String[] args) {
        System.out.println("=== CONSUMO DE API #190 ===");
        try {
            HttpClient cliente = HttpClient.newHttpClient();
            HttpRequest peticion = HttpRequest.newBuilder()
                    .uri(URI.create("https://jsonplaceholder.typicode.com/todos/" + (190 - 180)))
                    .GET().build();
